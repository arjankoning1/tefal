...
unalias -a
echo
echo "       TEFAL installation (Version December 29 2024) (C) Copyright 2024 Arjan Koning All Rights Reserved"
echo
echo " Two ways to use this script:"
echo
echo " install_tefal.bash 'Arjan Koning'"
echo "     Replace  Arjan Koning by your own name"
echo
echo " or"
echo
echo " install_tefal.bash"
